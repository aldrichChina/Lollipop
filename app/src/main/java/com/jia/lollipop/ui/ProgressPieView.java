...
public class ProgressPieView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.jia.lollipop.R.styleable.ProgressPieView);
        final Resources res = getResources();

        mMax = a.getInteger(com.jia.lollipop.R.styleable.ProgressPieView_ppvMax, mMax);
        mProgress = a.getInteger(com.jia.lollipop.R.styleable.ProgressPieView_ppvProgress, mProgress);
        mStartAngle = a.getInt(com.jia.lollipop.R.styleable.ProgressPieView_ppvStartAngle, mStartAngle);
        mInverted = a.getBoolean(com.jia.lollipop.R.styleable.ProgressPieView_ppvInverted, mInverted);
        mCounterclockwise = a.getBoolean(com.jia.lollipop.R.styleable.ProgressPieView_ppvCounterclockwise, mCounterclockwise);
        mStrokeWidth = a.getDimension(com.jia.lollipop.R.styleable.ProgressPieView_ppvStrokeWidth, mStrokeWidth);
        mTypeface = a.getString(com.jia.lollipop.R.styleable.ProgressPieView_ppvTypeface);
        mTextSize = a.getDimension(com.jia.lollipop.R.styleable.ProgressPieView_android_textSize, mTextSize);
        mText = a.getString(com.jia.lollipop.R.styleable.ProgressPieView_android_text);

        mShowStroke = a.getBoolean(com.jia.lollipop.R.styleable.ProgressPieView_ppvShowStroke, mShowStroke);
        mShowText = a.getBoolean(com.jia.lollipop.R.styleable.ProgressPieView_ppvShowText, mShowText);
        mImage = a.getDrawable(com.jia.lollipop.R.styleable.ProgressPieView_ppvImage);

        int backgroundColor = Color.parseColor("#00000000");
        backgroundColor = a.getColor(com.jia.lollipop.R.styleable.ProgressPieView_ppvBackgroundColor, backgroundColor);
        int progressColor = Color.parseColor("#33b5e5");
        progressColor = a.getColor(com.jia.lollipop.R.styleable.ProgressPieView_ppvProgressColor, progressColor);
        int strokeColor = Color.parseColor("#33b5e5");
        strokeColor = a.getColor(com.jia.lollipop.R.styleable.ProgressPieView_ppvStrokeColor, strokeColor);
        int textColor = Color.parseColor("#333333");
        textColor = a.getColor(com.jia.lollipop.R.styleable.ProgressPieView_android_textColor, textColor);

        mProgressFillType = a.getInteger(com.jia.lollipop.R.styleable.ProgressPieView_ppvProgressFillType, mProgressFillType);
