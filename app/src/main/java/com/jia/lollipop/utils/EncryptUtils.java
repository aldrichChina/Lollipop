...
public class EncryptUtils {
	...
	public static String encryptMD5File2String(File file) {
		return encryptMD5File(file) != null ? ConvertUtils
				.bytes2HexString(encryptMD5File(file)) : "";
	}
	...
	public static byte[] DESTemplet(byte[] data, byte[] key, String algorithm,
	...
	public static byte[] encrypt3DES(byte[] data, byte[] key) {
		return DESTemplet(data, key, TripleDES_Algorithm,
				TripleDES_Transformation, true);
	}
	...
	public static byte[] decrypt3DES(byte[] data, byte[] key) {
		return DESTemplet(data, key, TripleDES_Algorithm,
				TripleDES_Transformation, false);
	}
	...
	/**
	 * @Description ios,android,java通用AES加解密
	 * @param seed
	 *            秘钥
	 * @param cleartext
	 *            内容
	...
	// 加密
	@SuppressLint("TrulyRandom")
	public static String SupportAesEncrypt(String encData, String secretKey,
			String vector) throws Exception {
	...
	// 解密
	public String SupportAesDecrypt(String sSrc, String key, String ivs) throws Exception {
		try {
	...
	public String SupportAesDecrypt(String sSrc, String sKey) throws Exception {
		try {
