...
import com.jia.lollipop.Bean.ApkInfo;
import com.jia.lollipop.ui.NumberProgressBar;
import com.jia.lollipop.utils.ApkUtils;
import com.jia.lollipop.utils.AppCacheUtils;
import com.jia.okhttpserver.download.DownloadInfo;
import com.jia.okhttpserver.download.DownloadManager;
import com.jia.okhttpserver.download.DownloadService;
import com.jia.okhttpserver.listener.DownloadListener;
import com.jia.okhttpserver.task.ExecutorWithListener;
...
public class DownloadManagerActivity extends AppCompatActivity implements View.OnClickListener, ExecutorWithListener.OnAllTaskEndListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jia.lollipop.R.layout.activity_download_manager);

        downloadManager = DownloadService.getDownloadManager();
        allTask = downloadManager.getAllTask();
        ListView listView = (ListView) findViewById(com.jia.lollipop.R.id.listView);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.jia.lollipop.R.id.removeAll:
                downloadManager.removeAllTask();
                adapter.notifyDataSetChanged();  //移除的时候需要调用
                break;
            case com.jia.lollipop.R.id.pauseAll:
                downloadManager.pauseAllTask();
                break;
            case com.jia.lollipop.R.id.stopAll:
                downloadManager.stopAllTask();
                break;
            case com.jia.lollipop.R.id.startAll:
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(DownloadManagerActivity.this, com.jia.lollipop.R.layout.item_download_manager, null);
            ...
            if (apk != null) {
                Glide.with(DownloadManagerActivity.this).load(apk.getIconUrl()).error(com.jia.lollipop.R.mipmap.ic_launcher).into(holder.icon);
    ...
    private class ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View convertView) {
            icon = (ImageView) convertView.findViewById(com.jia.lollipop.R.id.icon);
            name = (TextView) convertView.findViewById(com.jia.lollipop.R.id.name);
            downloadSize = (TextView) convertView.findViewById(com.jia.lollipop.R.id.downloadSize);
            tvProgress = (TextView) convertView.findViewById(com.jia.lollipop.R.id.tvProgress);
            netSpeed = (TextView) convertView.findViewById(com.jia.lollipop.R.id.netSpeed);
            pbProgress = (NumberProgressBar) convertView.findViewById(com.jia.lollipop.R.id.pbProgress);
            download = (Button) convertView.findViewById(com.jia.lollipop.R.id.start);
            remove = (Button) convertView.findViewById(com.jia.lollipop.R.id.remove);
            restart = (Button) convertView.findViewById(com.jia.lollipop.R.id.restart);
        }
