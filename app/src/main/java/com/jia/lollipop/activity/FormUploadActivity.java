...
import com.jia.lollipop.callback.JsonCallback;
import com.jia.lollipop.ui.NumberProgressBar;
import com.jia.lollipop.utils.Constant;
import com.jia.lollipop.utils.GlideImageLoader;
...
public class FormUploadActivity extends BaseActivity {
    ...
    @Bind(com.jia.lollipop.R.id.formUpload) Button btnFormUpload;
    @Bind(com.jia.lollipop.R.id.downloadSize) TextView tvDownloadSize;
    @Bind(com.jia.lollipop.R.id.tvProgress) TextView tvProgress;
    @Bind(com.jia.lollipop.R.id.netSpeed) TextView tvNetSpeed;
    @Bind(com.jia.lollipop.R.id.pbProgress)
    NumberProgressBar pbProgress;
    @Bind(com.jia.lollipop.R.id.images) TextView tvImages;

    private ArrayList<ImageItem> imageItems;

    @Override
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(com.jia.lollipop.R.layout.activity_form_upload);
    ...
    @OnClick(com.jia.lollipop.R.id.selectImage)
    ...
    @OnClick(com.jia.lollipop.R.id.formUpload)
