...
import com.jia.okhttputils.callback.FileCallback;
...
public class FileDownloadActivity extends BaseActivity {
    ...
    @Bind(com.jia.lollipop.R.id.fileDownload) Button btnFileDownload;
    ...
    @Bind(com.jia.lollipop.R.id.pbProgress) NumberProgressBar pbProgress;

    @Override
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(com.jia.lollipop.R.layout.activity_file_download);
    ...
    @OnClick(com.jia.lollipop.R.id.fileDownload)
