...
import com.jia.okhttputils.cache.CacheManager;
...
public class CacheActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(com.jia.lollipop.R.layout.activity_cache);
    ...
    @OnClick(com.jia.lollipop.R.id.getAll)
    ...
    @OnClick(com.jia.lollipop.R.id.clear)
    ...
    @OnClick(com.jia.lollipop.R.id.no_cache)
    ...
    @OnClick(com.jia.lollipop.R.id.cache_default)
    ...
    @OnClick(com.jia.lollipop.R.id.request_failed_read_cache)
    ...
    @OnClick(com.jia.lollipop.R.id.if_none_cache_request)
    ...
    @OnClick(com.jia.lollipop.R.id.first_cache_then_request)
