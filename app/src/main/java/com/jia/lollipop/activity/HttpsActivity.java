...
import com.jia.lollipop.callback.StringDialogCallback;
...
public class HttpsActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(com.jia.lollipop.R.layout.activity_https);
    ...
    @OnClick(com.jia.lollipop.R.id.btn_none_https_request)
    ...
    @OnClick(com.jia.lollipop.R.id.btn_https_request)
