...
public class DesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jia.lollipop.R.layout.activity_download_details);
        apk = (ApkInfo) getIntent().getSerializableExtra("apk");
        downloadManager = DownloadService.getDownloadManager();

        ImageView icon = (ImageView) findViewById(com.jia.lollipop.R.id.icon);
        TextView name = (TextView) findViewById(com.jia.lollipop.R.id.name);
        downloadSize = (TextView) findViewById(com.jia.lollipop.R.id.downloadSize);
        tvProgress = (TextView) findViewById(com.jia.lollipop.R.id.tvProgress);
        netSpeed = (TextView) findViewById(com.jia.lollipop.R.id.netSpeed);
        pbProgress = (ProgressBar) findViewById(com.jia.lollipop.R.id.pbProgress);
        download = (Button) findViewById(com.jia.lollipop.R.id.start);
        remove = (Button) findViewById(com.jia.lollipop.R.id.remove);
        restart = (Button) findViewById(com.jia.lollipop.R.id.restart);

        Glide.with(this).load(apk.getIconUrl()).error(com.jia.lollipop.R.mipmap.ic_launcher).into(icon);
